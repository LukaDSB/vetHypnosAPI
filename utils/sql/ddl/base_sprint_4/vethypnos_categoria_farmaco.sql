...
=======
<<<<<<< HEAD:utils/sql/ddl/base_sprint_4/vethypnos_categoria_farmaco.sql
-- Host: localhost    Database: vethypnos
=======
-- Host: 127.0.0.1    Database: vethypnos
>>>>>>> 89a1afc (Contato nao testado):utils/sql/ddl/dump2/dosesanestesicas_categoria_farmaco.sql
