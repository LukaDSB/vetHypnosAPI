...
CREATE TABLE `prescricoes` (
  ...
  CONSTRAINT `prescricoes_ibfk_1` FOREIGN KEY (`Paciente_ID`) REFERENCES `paciente` (`ID`),
  CONSTRAINT `prescricoes_ibfk_2` FOREIGN KEY (`Usuario_ID`) REFERENCES `usuarios` (`ID`),
